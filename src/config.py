...
GSHEETS_URL: str = _get_secret(""""Điểm vào chính của ứng dụng ANAN - Cổng Học Tập THCS.
...
ADMIN_PASSWORD: str = _get_secret(""""Điểm vào chính của ứng dụng ANAN - Cổng Học Tập THCS.
